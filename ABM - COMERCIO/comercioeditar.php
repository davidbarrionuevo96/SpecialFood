                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                ...
                                <input type="text" name="Comercio_nombre" id="Comercio_nombre" class="form-control input-sm" placeholder="Nombre*" value='<?php echo $nombre; ?>'>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="Comercio_CUIT" id="Comercio_CUIT" class="form-control input-sm" placeholder="CUIT*" value='<?php echo $cuit; ?>'>
                                </div>
                            </div>                            
                        </div>
        ...
        if(isset($_POST["Guardar"])) {
            ...
            if (empty($nombre) || empty($cuit)) {
                ...
                if (!($row['Nombre'] == $nombre)) {
                    ...
                    $sql = "UPDATE Comercio SET Nombre = '".$nombre."',CUIT ='".$cuit."";
