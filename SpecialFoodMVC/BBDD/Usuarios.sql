...
INSERT INTO `specialfooddb`.`usuario`
(`Nombre`,`Apellido`,`IdCalle`,`Numero`,`DNI`,`Email`,`Username`,`Password`,`CUIL`,`IdPerfil`,`IdEstadoAprobacionUsuario`,`BajaLogica`,`FechaModificacion`,`IdUsuarioModificacion`)
VALUES("comercio","comercio",1,2172,22222,"comercio@comercio.com","comercio","comercio",2022225,2,2,0,now(),1);

INSERT INTO `specialfooddb`.`usuario`
(`Nombre`,`Apellido`,`IdCalle`,`Numero`,`DNI`,`Email`,`Username`,`Password`,`CUIL`,`IdPerfil`,`IdEstadoAprobacionUsuario`,`BajaLogica`,`FechaModificacion`,`IdUsuarioModificacion`)
VALUES("delivery","delivery",1,2172,333333,"delivery@delivery.com","delivery","delivery",203333335,3,2,0,now(),1);
