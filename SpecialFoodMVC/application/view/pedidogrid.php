...
$SQL = $SQL . "     ,CONCAT(ca.Descripcion, ' ', pv.Numero, ' ', bc.Descripcion) CalleComercio ";
$SQL = $SQL . "     ,CONCAT(cau.Descripcion, ' ', cli.Numero, ' ', bu.Descripcion) CalleCliente ";
$SQL = $SQL . "     ,p.IdEstadoPedido ";
$SQL = $SQL . "     ,CASE WHEN p.IdEstadoPedido = 3 THEN 1 WHEN p.IdEstadoPedido = 2 THEN 2 WHEN p.IdEstadoPedido = 4 THEN 3 END Orden ";
$SQL = $SQL . "FROM ";
$SQL = $SQL . "     Pedido p ";
...
$SQL = $SQL . "ORDER BY ";
$SQL = $SQL . "     13 ASC LIMIT $start , $limit";
