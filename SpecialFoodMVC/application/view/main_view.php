						...
						<div class="row section-gap">
								...
								<div class="single-footer-widget">
									...
									<ul class="hr-list">
										<li class="d-flex justify-content-between">
											<span>Lunes a Domingos</span> <span>TODO el día!</span>
										</li>
									</ul>
								</div>
							</div>
							<div class="col-lg-4  col-md-6 col-sm-6">
								<div class="single-footer-widget">
									<h4>Contacto</h4>
									<p>
										Florencio Varela 1903, B1754 San Justo, Pcia de Buenos Aires
									</p>
									<p class="number">
										011 4480-8900
									</p>
							...
							<div class="col-lg-4  col-md-6 col-sm-6">
								<div class="single-footer-widget">
									<h4>Newsletter</h4>
									<p>Suscribite al newsletter y recibí las mejores ofertas y descuentos.</p>
									<div class="d-flex flex-row" id="mc_embed_signup">
										  <form class="navbar-form" action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&amp;id=92a4423d01" method="get">
										    <div class="input-group add-on align-items-center d-flex">
										      	<input class="form-control" name="EMAIL" placeholder="Your Email address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Tu E-mail'" required="" type="email">
