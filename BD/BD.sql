...
IdFuncionalidad integer PRIMARY KEY,
Descripcion varchar(100));
...
IdPerfilFuncionalidad integer PRIMARY KEY,
IdPerfil integer,
...
IdEstadoAprobacionUsuario integer PRIMARY KEY,
Descripcion varchar (100));
...
IdHistorialActivacionDelivery integer PRIMARY KEY,
IdDelivery integer,
FechaLogin datetime,
...
IdUsuarioComercio integer PRIMARY KEY,
IdComercio integer,
IdUsuario integer,
...
IdMenuComercio integer PRIMARY KEY,
Descripcion varchar(100),
IdComercio integer,
FOREIGN KEY (IdComercio) references Comercio (IdComercio));

Create Table MenuNegocioItem(
IdMenuNegocioItem integer PRIMARY KEY,
...
IdPuntoDeVenta integer PRIMARY KEY,
Numero integer,
IdComercio integer,
IdCalle integer,
FOREIGN KEY (IdComercio) references Comercio (idComercio),
...
IdEstadoEntrega integer PRIMARY KEY,
Descripcion varchar (100));
...
IdPedidoItem integer PRIMARY KEY,
Cantidad integer,
